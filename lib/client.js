window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			waitingTrouble: "如果 Figma 页面显示报错（例如「Invalid scopes for app」），说明该 OAuth 应用缺少对应权限，本页不会自动更新；请在 Figma 后台补齐权限后重新连接。",
			reopen: "重新打开授权页面",
			cancel: "取消",
		...
		const en = {
			...
			waitingTrouble: "If Figma's page shows an error (for example \"Invalid scopes for app\"), the OAuth app is missing one of the requested scopes. This page will not update on its own — fix the app's scopes in Figma, then reconnect.",
