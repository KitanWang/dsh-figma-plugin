...
import { isOAuthAppConfigured, resolveOAuthApp } from './oauth-app.js';
...
export class FigmaConnection {
   ...
   * @param options - redirect URI override and an injectable fetch.
   */
   ...
   */
  client() {
    return resolveOAuthApp(this.#config);
  }

  /** Whether this deployment has a usable OAuth client at all. */
  get appConfigured() {
    return isOAuthAppConfigured() || this.client() !== undefined;
  }
